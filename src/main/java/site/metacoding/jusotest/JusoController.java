...
public class JusoController {
    ...
    @GetMapping("/")
    public String jusoTest(Model model) {
        String jusoUrl = "https://www.juso.go.kr/addrlink/addrLinkUrl.do?confmKey=devU01TX0FVVEgyMDIyMDUyMzEwNDk0ODExMjYwMDI=&returnUrl=http://localhost:8080/juso/callback&resultType=4";
